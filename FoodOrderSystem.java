package core_java_Food_Ordering_System;
    ...
    public static void main(String[] args) {
        ...
        while (true) 
        {
            ...
            else if (choice == 2) 
            {
                ...
                System.out.println("Main Course Recipes:");
                        FoodItem[] mainCourseItems = mainCourse.getMainCourses();
                        int itemIndex = 1;
                        for (FoodItem item : mainCourseItems) 
                        {
                            System.out.println(itemIndex + ": " + item.getName() + " - Rs. " + item.getPrice());
                            itemIndex++;
                        }
                        ...
                        if (itemNumber >= 1 && itemNumber <= mainCourseItems.length) 
                        {
                            orders[orderIndex] = new Order(mainCourseItems[itemNumber - 1], quantity);
                            totalBill += orders[orderIndex].getTotalPrice();
                            orderIndex++;
                        } 
                        else 
            ...
            else if (choice == 3) 
            {
                ...
                FoodItem[] dessertItems = desserts.getDesserts();
                int itemIndex = 1;
                ...
                if (itemNumber >= 1 && itemNumber <= dessertItems.length) 
                {
                    orders[orderIndex] = new Order(dessertItems[itemNumber - 1], quantity);
                    totalBill += orders[orderIndex].getTotalPrice();
                    orderIndex++;
                } 
                else 
            ...
            else if (choice == 4) 
            {
                ...
                FoodItem[] drinkItems = drinks.getDrinks();
                int itemIndex = 1;
                for (FoodItem item : drinkItems) 
                {
                    System.out.println(itemIndex + ": " + item.getName() + " - Rs. " + item.getPrice());
                    itemIndex++;
                }
                ...
                if (itemNumber >= 1 && itemNumber <= drinkItems.length) 
                {
                    orders[orderIndex] = new Order(drinkItems[itemNumber - 1], quantity);
                    totalBill += orders[orderIndex].getTotalPrice();
                    orderIndex++;
                } 
                else 
        ...
        for (int i = 0; i < orderIndex; i++) 
        {
            ...
            System.out.println(
                    order.getItem().getName() + " x " + order.getQuantity() + " - Rs. " + order.getTotalPrice());
        }
        System.out.println("----------------------------");
